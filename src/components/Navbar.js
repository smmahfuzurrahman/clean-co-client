    ...
    return (
        <div class="drawer drawer-end" data-theme={dark ? "dark" : "light"}>
            ...
            <div class="drawer-content flex flex-col">
                <div class="w-full navbar bg-base-100 fixed top-0 lg:px-20 z-50">
                    ...
                    <div class="flex-none hidden lg:block">
                        <ul class="menu menu-horizontal gap-x-2">
                            ...
                            {admin && (
                                <li><NavLink to='/dashboard/add-admin' className='rounded-lg'>Dashboard</NavLink></li>
                            )}
                ...
                <ul class="menu p-4 overflow-y-auto w-80 bg-base-100">
                    ...
                    <div tabindex="0" class="collapse collapse-arrow border border-base-300 bg-base-100 rounded-box">
                        ...
                        <div class="collapse-content">
                            <li><NavLink to='/contact' className='rounded-lg'>Premium Book</NavLink></li>
